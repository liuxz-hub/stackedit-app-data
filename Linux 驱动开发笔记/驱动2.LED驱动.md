...
# 三、驱动程序编写
1、加载头文件
2、宏定义**寄存器物理地址 **，如`#define CCM_CCGR1_BASE				(0X020C406C)`;
3、创建映射后的寄存器虚拟地址指针，如`static void __iomem *IMX6U_CCM_CCGR1;`;
4\
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkwOTg3NDQ5Niw5MTQ2NzM2NjgsLTE1MD
I3MzU0NDBdfQ==
-->