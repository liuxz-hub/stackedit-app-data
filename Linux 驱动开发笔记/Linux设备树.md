...
注意：某一子节点 reg 属性值是根据其父节点设置的address-cells 和 #size-cells 属性来写，例如父节点规定`#address-cells = <1>; #size-cells = <0>;` 则子节点 reg 属性值为`reg = <0x02280000>;`。
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NjUyMDgxNzUsMTA2ODk1MjQwNCwtMT
