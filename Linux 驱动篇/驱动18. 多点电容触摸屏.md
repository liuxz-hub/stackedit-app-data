...
## 2、Type B
适用于有硬件追踪并能区分触摸点的触摸设备，通过 slot 机制区分且更新ge触摸点的信息， FT5426 就属于此类型，一般的多点电容触摸屏 IC 都有此能力。
```cpp
   ABS_MT_SLOT 0			/*触摸点0*/
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMDg3NDQ1NDYsMTAyNDg3MTg4MiwxNj
Q0NDMyNDU5LC0yMDg4NzQ2NjEyXX0=
-->