...
|void input_mt_report_pointer_emulation(struct input_dev *dev, bool use_count)|获取到具体的触摸点数量|code：要上报的是 X 轴或者 Y 轴，value： 具体的 坐标数据值
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2MDUzMDUyMCwtMTczNDg3ODU1NywtMT
