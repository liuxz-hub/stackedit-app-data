...
static int icm20608_write_regs(struct icm20608_dev *dev, u8 reg, u8 *buf, int len){
	...
	txdata[0] = reg & ~0x80;		/*要写入的寄存器地址*/
	memcpy(&txdata[1], buf, len);	/*将要发送的数据拷贝到txdata中*/
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk3MDc0MTI2MywtMTYxNDQ2NjU3OSwtMT
AxMDIxMDg3OCwtMjg3OTQzOTIyLDYwNDM2NjksLTcyMzMzNjk0
Niw1NDk5ODI1MjYsLTMzNTUwODU3NSwxNjMyNTA3NTA0LDIxMT
E2MzEzNTUsLTIwNjM2ODk3MDAsMTA0NDE3MTg1NCwtMjA3NDM3
OTQ3LC0xNzA5NzIyMDEzLC0yMDA3NTY3OTI5XX0=
-->