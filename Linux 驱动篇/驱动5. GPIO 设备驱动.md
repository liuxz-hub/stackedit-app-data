...
添加之后可以在开发版上进去 Linux 系统，通过命令`cd /proc/device-tree`来查看节点是否创建成功。

## 3.2  驱动编写
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MzA2NzIyMzQsLTY5NjQ3NDYwMCwxNj
k5MzUwNDYzLC03MzA4MzA4ODIsMTY5NjE4MDQ4OF19
-->