...
| `int del_timer`(struct timer_list * timer)  | 删除一个定时器（需要在其他要先等待其他处理器的定时处理器函数退出）。返回值： 0，定时器还没被激活； 1，定时器已经激活 |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMjQ2MzM5NDIsOTg0NjIwOTIwLDE3ND
QxMTEzMTcsMTM2ODI5MzIxOSwtMTg4NTk0NzUxLDIwNTU1NjA5
NSwtODgzMDMzMTU1LDMxNzMxNzAxMiwxODkxNDg1NjhdfQ==
-->