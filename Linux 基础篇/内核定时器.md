...
| 函数                                       | 描述                                                                 |
|--------------------------------------------|----------------------------------------------------------------------|
| `int jiffies_to_msecs`(const unsigned long j) | 将 jiffies 值 `j` 转换为毫秒数                                 |
| `int jiffies_to_usecs`(const unsigned long j) | 将 jiffies 值 `j` 转换为微秒数                                   |
| `u64 jiffies_to_nsecs`(const unsigned long j) | 将 jiffies 值 `j` 转换为纳秒数                                   |
...
| 函数                                       | 描述                                                                 | 返回值说明               |
|--------------------------------------------|----------------------------------------------------------------------|--------------------------|
| `void init_timer`(struct timer_list *timer) | 负责初始化 timer_list 类型变量    |
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4ODUyMTkyNDQsMTM2ODI5MzIxOSwtMT
g4NTk0NzUxLDIwNTU1NjA5NSwtODgzMDMzMTU1LDMxNzMxNzAx
MiwxODkxNDg1NjhdfQ==
-->