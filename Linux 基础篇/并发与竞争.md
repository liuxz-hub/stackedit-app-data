...
①、因为信号量可以使等待资源线程进入`休眠状态`，因此适用于那些占用资源比较久的场合；

②、因此信号量`不能用于中断中`，因为信号量会引起休眠，中断不能休眠；

③、信号量频繁的休眠、切换线程引起的开销要远大于

2、信号量的分类

①、计数型信号量（仅信号量值不大于1时，才能用于互斥访问）；

②、
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY4NjU2OTI4OCwxNzY1MzQyNzcwLDIwNT
I1OTY2NzcsLTEwNDQyMjAyMzYsMjc5MzM1MjU5LDE0MDg5NjQ0
LC00Mzg2NDg1MzksLTY5NTU1Mzg4NywtNjkwNDc5NDAsMTE0ND
I0MDc0OF19
-->