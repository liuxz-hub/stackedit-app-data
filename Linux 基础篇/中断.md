...
&emsp;&emsp;函数参数和返回值含义如下：  
&emsp;&emsp;gpio： 要获取的 GPIO 编号。  
&emsp;&emsp;返回值： GPIO 对应的中断号。
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTU5NjIwMjk5LC0xMjg3NTA4NzIyLC02MD
cyOTAxNjQsNDQ3MjUxOTEyLC0xNTQxMDAxMDc4LC0xMzI2ODA0
MzcyXX0=
-->