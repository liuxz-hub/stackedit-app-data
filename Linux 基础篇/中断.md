...
## 4、上半部和下半部
1、#interrupt-cells 指定interrupt 的 cells 数量，也就是属性interrupts。←
intc: interrupt-controller@00a01000 {ecompatible ="arm,cortex-a7-gic";#interrupt-cells = <3>;←interrupt-controller;e
reg =<0x00a01000 0x1000>,-
<0x00a02000 0x100>;
gpio5: gpio@020ac000 {~compatible = "fsl,imx6ul-gpio", "fsl,imx35-gpio";reg = <0x020ac000 0x4000>;←interrypts = <GIC SPI 74 IRQ_TYPE LEVEL HIGH>,<GIC SPI 75 IRO TYPE LEVEL HIGH>:
gpio-controller;←
#gpio-cells = <2>;←
interrupt-controller;#interrupt-cells =<2>;←
<!--stackedit_data:
eyJoaXN0b3J5IjpbODgwNDQ3MjQ5LC02MDcyOTAxNjQsNDQ3Mj
UxOTEyLC0xNTQxMDAxMDc4LC0xMzI2ODA0MzcyXX0=
-->